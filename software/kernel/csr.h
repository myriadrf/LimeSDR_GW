...
#define CSR_SPIFLASH_CORE_BASE (CSR_BASE + 0x7000L)
#define CSR_SPIFLASH_CORE_MMAP_DUMMY_BITS_ADDR (CSR_BASE + 0x7000L)
#define CSR_SPIFLASH_CORE_MMAP_DUMMY_BITS_SIZE 1

/* SPIFLASH_CORE Fields */

/* SPIFLASH_PHY Registers */
#define CSR_SPIFLASH_PHY_BASE (CSR_BASE + 0x7800L)
#define CSR_SPIFLASH_PHY_CLK_DIVISOR_ADDR (CSR_BASE + 0x7800L)
...
/* LIME_TOP Registers */
#define CSR_LIME_TOP_BASE (CSR_BASE + 0x4800L)
#define CSR_LIME_TOP_SCRATCH_ADDR (CSR_BASE + 0x4800L)
#define CSR_LIME_TOP_SCRATCH_SIZE 1
#define CSR_LIME_TOP_EV_STATUS_ADDR (CSR_BASE + 0x4804L)
#define CSR_LIME_TOP_EV_STATUS_SIZE 1
#define CSR_LIME_TOP_EV_PENDING_ADDR (CSR_BASE + 0x4808L)
#define CSR_LIME_TOP_EV_PENDING_SIZE 1
#define CSR_LIME_TOP_EV_ENABLE_ADDR (CSR_BASE + 0x480cL)
#define CSR_LIME_TOP_EV_ENABLE_SIZE 1
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_ADDR (CSR_BASE + 0x4810L)
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_SIZE 1
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_DIR_ADDR (CSR_BASE + 0x4814L)
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_DIR_SIZE 1
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_VAL_ADDR (CSR_BASE + 0x4818L)
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_VAL_SIZE 1
#define CSR_LIME_TOP_GPIO_GPIO_VAL_ADDR (CSR_BASE + 0x481cL)
#define CSR_LIME_TOP_GPIO_GPIO_VAL_SIZE 1
#define CSR_LIME_TOP_ANALYZER_MUX_VALUE_ADDR (CSR_BASE + 0x4820L)
#define CSR_LIME_TOP_ANALYZER_MUX_VALUE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_TRIGGER_ENABLE_ADDR (CSR_BASE + 0x4824L)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_ENABLE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_TRIGGER_DONE_ADDR (CSR_BASE + 0x4828L)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_DONE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_WRITE_ADDR (CSR_BASE + 0x482cL)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_WRITE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_MASK_ADDR (CSR_BASE + 0x4830L)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_MASK_SIZE 3
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_VALUE_ADDR (CSR_BASE + 0x483cL)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_VALUE_SIZE 3
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_FULL_ADDR (CSR_BASE + 0x4848L)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_FULL_SIZE 1
#define CSR_LIME_TOP_ANALYZER_SUBSAMPLER_VALUE_ADDR (CSR_BASE + 0x484cL)
#define CSR_LIME_TOP_ANALYZER_SUBSAMPLER_VALUE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_ENABLE_ADDR (CSR_BASE + 0x4850L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_ENABLE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_DONE_ADDR (CSR_BASE + 0x4854L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_DONE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_LENGTH_ADDR (CSR_BASE + 0x4858L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_LENGTH_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_OFFSET_ADDR (CSR_BASE + 0x485cL)
#define CSR_LIME_TOP_ANALYZER_STORAGE_OFFSET_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_MEM_LEVEL_ADDR (CSR_BASE + 0x4860L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_MEM_LEVEL_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_MEM_DATA_ADDR (CSR_BASE + 0x4864L)
