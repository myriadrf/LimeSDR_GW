...
#define CSR_LIME_TOP_EV_STATUS_ADDR (CSR_BASE + 0x6804L)
#define CSR_LIME_TOP_EV_STATUS_SIZE 1
#define CSR_LIME_TOP_EV_PENDING_ADDR (CSR_BASE + 0x6808L)
#define CSR_LIME_TOP_EV_PENDING_SIZE 1
#define CSR_LIME_TOP_EV_ENABLE_ADDR (CSR_BASE + 0x680cL)
#define CSR_LIME_TOP_EV_ENABLE_SIZE 1
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_ADDR (CSR_BASE + 0x6810L)
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_SIZE 1
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_DIR_ADDR (CSR_BASE + 0x6814L)
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_DIR_SIZE 1
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_VAL_ADDR (CSR_BASE + 0x6818L)
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_VAL_SIZE 1
#define CSR_LIME_TOP_GPIO_GPIO_VAL_ADDR (CSR_BASE + 0x681cL)
#define CSR_LIME_TOP_GPIO_GPIO_VAL_SIZE 1
#define CSR_LIME_TOP_ANALYZER_MUX_VALUE_ADDR (CSR_BASE + 0x6820L)
#define CSR_LIME_TOP_ANALYZER_MUX_VALUE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_TRIGGER_ENABLE_ADDR (CSR_BASE + 0x6824L)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_ENABLE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_TRIGGER_DONE_ADDR (CSR_BASE + 0x6828L)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_DONE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_WRITE_ADDR (CSR_BASE + 0x682cL)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_WRITE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_MASK_ADDR (CSR_BASE + 0x6830L)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_MASK_SIZE 3
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_VALUE_ADDR (CSR_BASE + 0x683cL)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_VALUE_SIZE 3
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_FULL_ADDR (CSR_BASE + 0x6848L)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_FULL_SIZE 1
#define CSR_LIME_TOP_ANALYZER_SUBSAMPLER_VALUE_ADDR (CSR_BASE + 0x684cL)
#define CSR_LIME_TOP_ANALYZER_SUBSAMPLER_VALUE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_ENABLE_ADDR (CSR_BASE + 0x6850L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_ENABLE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_DONE_ADDR (CSR_BASE + 0x6854L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_DONE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_LENGTH_ADDR (CSR_BASE + 0x6858L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_LENGTH_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_OFFSET_ADDR (CSR_BASE + 0x685cL)
#define CSR_LIME_TOP_ANALYZER_STORAGE_OFFSET_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_MEM_LEVEL_ADDR (CSR_BASE + 0x6860L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_MEM_LEVEL_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_MEM_DATA_ADDR (CSR_BASE + 0x6864L)
