...
#define CSR_LIME_TOP_TX_PATH_CH_EN_ADDR (CSR_BASE + 0x7918L)
#define CSR_LIME_TOP_TX_PATH_CH_EN_SIZE 1
#define CSR_LIME_TOP_TX_PATH_SMPL_WIDTH_ADDR (CSR_BASE + 0x791cL)
#define CSR_LIME_TOP_TX_PATH_SMPL_WIDTH_SIZE 1
#define CSR_LIME_TOP_TX_PATH_SYNC_DIS_ADDR (CSR_BASE + 0x7920L)
#define CSR_LIME_TOP_TX_PATH_SYNC_DIS_SIZE 1
#define CSR_LIME_TOP_EV_STATUS_ADDR (CSR_BASE + 0x7924L)
#define CSR_LIME_TOP_EV_STATUS_SIZE 1
#define CSR_LIME_TOP_EV_PENDING_ADDR (CSR_BASE + 0x7928L)
#define CSR_LIME_TOP_EV_PENDING_SIZE 1
#define CSR_LIME_TOP_EV_ENABLE_ADDR (CSR_BASE + 0x792cL)
