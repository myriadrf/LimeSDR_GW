//--------------------------------------------------------------------------------
// Auto-generated by LiteX (473784581) on 2024-07-15 10:55:02
//--------------------------------------------------------------------------------
...
#define CSR_ANALYZER_CNTRL_BASE (CSR_BASE + 0x2800L)
#define CSR_ANALYZER_CNTRL_MUX_VALUE_ADDR (CSR_BASE + 0x2800L)
#define CSR_ANALYZER_CNTRL_MUX_VALUE_SIZE 1
#define CSR_ANALYZER_CNTRL_TRIGGER_ENABLE_ADDR (CSR_BASE + 0x2804L)
#define CSR_ANALYZER_CNTRL_TRIGGER_ENABLE_SIZE 1
#define CSR_ANALYZER_CNTRL_TRIGGER_DONE_ADDR (CSR_BASE + 0x2808L)
#define CSR_ANALYZER_CNTRL_TRIGGER_DONE_SIZE 1
#define CSR_ANALYZER_CNTRL_TRIGGER_MEM_WRITE_ADDR (CSR_BASE + 0x280cL)
#define CSR_ANALYZER_CNTRL_TRIGGER_MEM_WRITE_SIZE 1
#define CSR_ANALYZER_CNTRL_TRIGGER_MEM_MASK_ADDR (CSR_BASE + 0x2810L)
#define CSR_ANALYZER_CNTRL_TRIGGER_MEM_MASK_SIZE 1
#define CSR_ANALYZER_CNTRL_TRIGGER_MEM_VALUE_ADDR (CSR_BASE + 0x2814L)
#define CSR_ANALYZER_CNTRL_TRIGGER_MEM_VALUE_SIZE 1
#define CSR_ANALYZER_CNTRL_TRIGGER_MEM_FULL_ADDR (CSR_BASE + 0x2818L)
#define CSR_ANALYZER_CNTRL_TRIGGER_MEM_FULL_SIZE 1
#define CSR_ANALYZER_CNTRL_SUBSAMPLER_VALUE_ADDR (CSR_BASE + 0x281cL)
#define CSR_ANALYZER_CNTRL_SUBSAMPLER_VALUE_SIZE 1
#define CSR_ANALYZER_CNTRL_STORAGE_ENABLE_ADDR (CSR_BASE + 0x2820L)
#define CSR_ANALYZER_CNTRL_STORAGE_ENABLE_SIZE 1
#define CSR_ANALYZER_CNTRL_STORAGE_DONE_ADDR (CSR_BASE + 0x2824L)
#define CSR_ANALYZER_CNTRL_STORAGE_DONE_SIZE 1
#define CSR_ANALYZER_CNTRL_STORAGE_LENGTH_ADDR (CSR_BASE + 0x2828L)
#define CSR_ANALYZER_CNTRL_STORAGE_LENGTH_SIZE 1
#define CSR_ANALYZER_CNTRL_STORAGE_OFFSET_ADDR (CSR_BASE + 0x282cL)
#define CSR_ANALYZER_CNTRL_STORAGE_OFFSET_SIZE 1
#define CSR_ANALYZER_CNTRL_STORAGE_MEM_LEVEL_ADDR (CSR_BASE + 0x2830L)
#define CSR_ANALYZER_CNTRL_STORAGE_MEM_LEVEL_SIZE 1
#define CSR_ANALYZER_CNTRL_STORAGE_MEM_DATA_ADDR (CSR_BASE + 0x2834L)
...
#define CSR_LIME_TOP_EV_STATUS_ADDR (CSR_BASE + 0x7804L)
#define CSR_LIME_TOP_EV_STATUS_SIZE 1
#define CSR_LIME_TOP_EV_PENDING_ADDR (CSR_BASE + 0x7808L)
#define CSR_LIME_TOP_EV_PENDING_SIZE 1
#define CSR_LIME_TOP_EV_ENABLE_ADDR (CSR_BASE + 0x780cL)
#define CSR_LIME_TOP_EV_ENABLE_SIZE 1
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_ADDR (CSR_BASE + 0x7810L)
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_SIZE 1
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_DIR_ADDR (CSR_BASE + 0x7814L)
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_DIR_SIZE 1
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_VAL_ADDR (CSR_BASE + 0x7818L)
#define CSR_LIME_TOP_GPIO_GPIO_OVERRIDE_VAL_SIZE 1
#define CSR_LIME_TOP_GPIO_GPIO_VAL_ADDR (CSR_BASE + 0x781cL)
#define CSR_LIME_TOP_GPIO_GPIO_VAL_SIZE 1
#define CSR_LIME_TOP_ANALYZER_MUX_VALUE_ADDR (CSR_BASE + 0x7820L)
#define CSR_LIME_TOP_ANALYZER_MUX_VALUE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_TRIGGER_ENABLE_ADDR (CSR_BASE + 0x7824L)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_ENABLE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_TRIGGER_DONE_ADDR (CSR_BASE + 0x7828L)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_DONE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_WRITE_ADDR (CSR_BASE + 0x782cL)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_WRITE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_MASK_ADDR (CSR_BASE + 0x7830L)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_MASK_SIZE 3
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_VALUE_ADDR (CSR_BASE + 0x783cL)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_VALUE_SIZE 3
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_FULL_ADDR (CSR_BASE + 0x7848L)
#define CSR_LIME_TOP_ANALYZER_TRIGGER_MEM_FULL_SIZE 1
#define CSR_LIME_TOP_ANALYZER_SUBSAMPLER_VALUE_ADDR (CSR_BASE + 0x784cL)
#define CSR_LIME_TOP_ANALYZER_SUBSAMPLER_VALUE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_ENABLE_ADDR (CSR_BASE + 0x7850L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_ENABLE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_DONE_ADDR (CSR_BASE + 0x7854L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_DONE_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_LENGTH_ADDR (CSR_BASE + 0x7858L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_LENGTH_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_OFFSET_ADDR (CSR_BASE + 0x785cL)
#define CSR_LIME_TOP_ANALYZER_STORAGE_OFFSET_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_MEM_LEVEL_ADDR (CSR_BASE + 0x7860L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_MEM_LEVEL_SIZE 1
#define CSR_LIME_TOP_ANALYZER_STORAGE_MEM_DATA_ADDR (CSR_BASE + 0x7864L)
#define CSR_LIME_TOP_ANALYZER_STORAGE_MEM_DATA_SIZE 1

/* LIME_TOP Fields */
#define CSR_LIME_TOP_EV_STATUS_IRQ0_OFFSET 0
#define CSR_LIME_TOP_EV_STATUS_IRQ0_SIZE 1
#define CSR_LIME_TOP_EV_STATUS_IRQ1_OFFSET 1
#define CSR_LIME_TOP_EV_STATUS_IRQ1_SIZE 1
#define CSR_LIME_TOP_EV_PENDING_IRQ0_OFFSET 0
#define CSR_LIME_TOP_EV_PENDING_IRQ0_SIZE 1
#define CSR_LIME_TOP_EV_PENDING_IRQ1_OFFSET 1
#define CSR_LIME_TOP_EV_PENDING_IRQ1_SIZE 1
#define CSR_LIME_TOP_EV_ENABLE_IRQ0_OFFSET 0
#define CSR_LIME_TOP_EV_ENABLE_IRQ0_SIZE 1
#define CSR_LIME_TOP_EV_ENABLE_IRQ1_OFFSET 1
#define CSR_LIME_TOP_EV_ENABLE_IRQ1_SIZE 1

/* PCIE_ENDPOINT Registers */
#define CSR_PCIE_ENDPOINT_BASE (CSR_BASE + 0x8000L)
#define CSR_PCIE_ENDPOINT_PHY_LINK_STATUS_ADDR (CSR_BASE + 0x8000L)
#define CSR_PCIE_ENDPOINT_PHY_LINK_STATUS_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_MSI_ENABLE_ADDR (CSR_BASE + 0x8004L)
#define CSR_PCIE_ENDPOINT_PHY_MSI_ENABLE_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_MSIX_ENABLE_ADDR (CSR_BASE + 0x8008L)
#define CSR_PCIE_ENDPOINT_PHY_MSIX_ENABLE_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_BUS_MASTER_ENABLE_ADDR (CSR_BASE + 0x800cL)
#define CSR_PCIE_ENDPOINT_PHY_BUS_MASTER_ENABLE_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_MAX_REQUEST_SIZE_ADDR (CSR_BASE + 0x8010L)
#define CSR_PCIE_ENDPOINT_PHY_MAX_REQUEST_SIZE_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_MAX_PAYLOAD_SIZE_ADDR (CSR_BASE + 0x8014L)
