...
int8_t litei2c_transfer(const litei2c_regs *regs, const uint8_t I2C_addr, uint32_t *buf, const uint8_t txlen, const uint8_t rxlen) {
    // Write active bit
...
int8_t litei2c_transfer_reordered(const litei2c_regs *regs, const uint8_t I2C_addr, uint32_t *buf, const uint8_t txlen, const uint8_t rxlen) {
