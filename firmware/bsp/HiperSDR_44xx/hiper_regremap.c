...
void readCSR(uint8_t *address, uint8_t *regdata_array) {
    ...
    switch (addr) {
        ...
        case 0xA:
            ...
            break;
        case 0xF:
            value = gpio_control_TDD_TXANT_PRE_read();
            break;
        case 0x10:
            value = gpio_control_TDD_TXANT_POST_read();
            break;
        case 0x11:
            value = gpio_control_TDDControlEnable_read();
            value |= (gpio_control_TDDSignalInvert_read() << 4);
            break;
        case 0x18:
            value = 0;
...
void writeCSR(uint8_t *address, uint8_t *wrdata_array) {
    ...
    switch (addr) {
        ...
        case 0x8:
            ...
            break;
        case 0xF:
            gpio_control_TDD_TXANT_PRE_write(value);
            break;
        case 0x10:
