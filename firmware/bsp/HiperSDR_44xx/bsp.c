...
litei2c_regs I2C2_REGS = {.master_active_addr   = CSR_I2C2_MASTER_ACTIVE_ADDR,
...
litei2c_regs I2C3_REGS = {.master_active_addr   = CSR_I2C3_MASTER_ACTIVE_ADDR,
