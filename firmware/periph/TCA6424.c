...
void TCA6424_SetPortPolarityInversion(const litei2c_regs *i2c_regs, const uint8_t addr, const uint8_t port, const uint8_t pol) {
    uint8_t reg_adr;
    // Choose a proper address to write to
    // Return without writing if an invalid value is provided
    // To avoid damage due to incorrect values
...
void TCA6424_ReadPortPolarityInversion(const litei2c_regs *i2c_regs, const uint8_t addr, const uint8_t port, uint8_t *pol) {
    uint8_t reg_adr;
    // Choose a proper address to write to
    // Return without writing if an invalid value is provided
    // To avoid damage due to incorrect values
