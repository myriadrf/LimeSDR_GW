...
//
// Filename   : fifo_w48x1024_r48.v
// Device     : 
// LiteX sha1 : c1225736a
// Date       : 2024-11-07 09:07:39
//------------------------------------------------------------------------------
...
wire          cdc_cd_rst;
wire   [49:0] cdc_cdc_asyncfifo_din;
wire   [49:0] cdc_cdc_asyncfifo_dout;
...
wire   [47:0] cdc_cdc_fifo_in_payload_data;
wire          cdc_cdc_fifo_out_first;
wire          cdc_cdc_fifo_out_last;
wire   [47:0] cdc_cdc_fifo_out_payload_data;
...
wire   [47:0] converter_converter_sink_payload_data;
...
wire   [47:0] converter_converter_source_payload_data;
...
wire   [47:0] converter_source_source_payload_data;
...
wire   [47:0] source_source_payload_data;
...
assign syncfifo_syncfifo_writable = (syncfifo_level != 11'd1024);
...
//------------------------------------------------------------------------------
// Memory storage_1: 4-words x 50-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: Sync | Mode: Read-First  | Write-Granularity: 50 
// Port 1 | Read: Sync  | Write: ---- | 
reg [49:0] storage_1[0:3];
reg [49:0] storage_1_dat0;
reg [49:0] storage_1_dat1;
always @(posedge from133_clk) begin
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2024-11-07 09:07:39.
//------------------------------------------------------------------------------
