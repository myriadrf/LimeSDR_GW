...
class FixedPointFFT(Elaboratable):
    ...
    def __init__(self,
        ...
        self.out_real = Signal(signed(bw))
        self.out_imag = Signal(signed(bw))
        ...
        self.wr_state = Signal()
        self.wr_state_valid = Signal()
    ...
    def elaborate(self, platform) -> Module:
        ...
        with m.FSM(reset="IDLE"):
            m.d.comb += self.wr_state_valid.eq(0)
            m.d.comb += self.wr_state.eq(0)
            ...
            with m.State("WINDOW"):
                m.d.comb += self.wr_state_valid.eq(1)
                m.d.comb += self.wr_state.eq(0)
