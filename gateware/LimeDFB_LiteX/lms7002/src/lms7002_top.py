...
class LMS7002Top(LiteXModule):
    def __init__(self, platform, pads=None, hw_ver=None, add_csr=True,
        ...
        # TODO: workaround for now. TX needs a buffer to work properly. Change this to asyncFifo or something in the future
        self.tx_cdc        = stream.SyncFIFO([("data", 64)], depth=s_axis_tx_fifo_words)
