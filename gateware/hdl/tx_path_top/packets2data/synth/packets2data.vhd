...
signal inst3_pct_buff_clr           : std_logic_vector(g_BUFF_COUNT-1 downto 0);
...
p2d_rd_inst3 : entity work.p2d_rd
   ...
   gen_pct_buff_clr : for i in 0 to g_BUFF_COUNT-1 generate
      inst3_pct_buff_clr(i) <= NOT inst3_pct_buff_clr_n(i);
   end generate;
