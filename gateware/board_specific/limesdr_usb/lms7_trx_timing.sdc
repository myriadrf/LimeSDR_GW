...
set_false_path -from * -to [get_ports LB_TX2*]
set_false_path -from * -to [get_ports LB_TX1*]
...
set_false_path -from [get_ports revision_HW_VER*] 			-to *
set_false_path -from [get_ports revision_BOM_VER*] 		-to *
...
#To be fixed
set_false_path -to [get_ports FPGA_SPI0_cs_n*]
...
set_false_path -to [get_ports FPGA_SPI1_clk]
