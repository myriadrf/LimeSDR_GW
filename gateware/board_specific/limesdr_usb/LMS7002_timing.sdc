...
set_input_delay	-max $LMS7_IN_MAX_DELAY \
						-clock [get_clocks LMS_MCLK2_VIRT_5MHz] [get_ports {LMS_DIQ2_D[*] LMS_ENABLE_IQSEL2}] -add_delay
...
set_output_delay	-max $LMS_LMS7_Tsu \
						-clock [get_clocks LMS_FCLK1_PLL] [get_ports {LMS_DIQ1_D[*] LMS_ENABLE_IQSEL1}]
...
set_output_delay	-max $LMS_LMS7_Tsu \
						...
						-clock_fall [get_ports {LMS_DIQ1_D[*] LMS_ENABLE_IQSEL1}] -add_delay
...
set_output_delay	-max $LMS_LMS7_Tsu \
						-clock [get_clocks LMS_FCLK1_DRCT] [get_ports {LMS_DIQ1_D[*] LMS_ENABLE_IQSEL1}] -add_delay
...
set_false_path -setup 	-rise_from 	[get_clocks LMS_MCLK1_5MHZ] -rise_to \
												[get_clocks LMS_FCLK1_DRCT]
set_false_path -setup 	-fall_from 	[get_clocks LMS_MCLK1_5MHZ] -fall_to \
												[get_clocks LMS_FCLK1_DRCT]
