...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=80e6, cpu_type="vexriscv", toolchain="quartus",
        ...
        **kwargs):
        ...
        self.fpgacfg  = FPGACfg(platform, board_id=0x0011, major_rev=1, compile_rev=30, pads=revision_pads)
    ...
    def add_internal_flash_data_probe(self):
        analyzer_signals = [
            ...
            self.internal_flash.avmm_data_read,
            self.internal_flash.avmm_data_readdata,
            self.internal_flash.avmm_data_readdatavalid,
            self.internal_flash.avmm_data_write,
