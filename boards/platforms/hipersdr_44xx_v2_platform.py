...
_io = [
    ...
    ("pcie_x4", 0,
     Subsignal("rst_n", Pins("AD15"), IOStandard("LVCMOS33"), Misc("PULLUP=TRUE")),
     Subsignal("clk_p", Pins("AB7")),
     Subsignal("clk_n", Pins("AB6")),
    ...
    ("SW_RX_LB_TDD_FDD", 0,
     Pins("AA22 A14 AC24 B14 AC21 A13 AB21 A12"),  # CHA_V1 CHA_V2 CHB_V1 CHB_V2 CHC_V1 CHC_V2 CHD_V1 CHD_V2
     # Is this really right? Switches are powered by 3.3V
     IOStandard("LVCMOS18"),
     ),
    ...
    # 40MHz reference clock (generated by VCTCXO)
    ("gpio_d11", 0, Pins("D11"), IOStandard("LVCMOS18")),

    ("pps", 0, Pins("AE25"), IOStandard("LVCMOS18")),

    ("gps_serial", 0,
     Subsignal("tx", Pins("AA23"), IOStandard("LVCMOS18")),
     Subsignal("rx", Pins("Y21"), IOStandard("LVCMOS18"))
     ),
    ...
    # Synchro.
    ("synchro", 0,
        Subsignal("pps_in", Pins("J11"), Misc("PULLDOWN=True")), # M2_1PPS_FPGA
    ...
    ("refctrl", 0,
     Subsignal("sel", Pins("G12"), Misc("PULLDOWN=True")),  # 0 OCXO, 1 - EXTCLK
     IOStandard("LVCMOS18")
     ),
    ...
    # GPIO33_0(IN)  - PCIe PERSTN (not included in this list)
    # GPIO33_1(OUT) - FAN1_PWM
    # GPIO33_2(OUT) - FAN0_PWM
    # GPIO33_3(IN)  - ADF4002_MUXOUT
    ("gpio33", 0, Pins("AE15 AF15"), IOStandard("LVCMOS33")), #GPIO33_1, GPIO33_2
