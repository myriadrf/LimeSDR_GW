...
- :doc:`Legacy FPGA SPI registers <limesdr-mini-v1/reg_remap/mini_v1_regremap_from_csv>`: legacy host registers used by existing software and previous gateware; planned to be replaced by LiteX CSR.
...
.. toctree::
   ...
   Legacy FPGA SPI register reference <limesdr-mini-v1/reg_remap/mini_v1_regremap_from_csv>
