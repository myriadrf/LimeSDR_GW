...
| Register                                                             | Address                                           |
+======================================================================+===================================================+
| :ref:`PPSDO_ENABLE <PPSDO_ENABLE>`                                   | :ref:`0xf000f000 <PPSDO_ENABLE>`                  |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_CONFIG_ONE_S_TARGET <PPSDO_CONFIG_ONE_S_TARGET>`         | :ref:`0xf000f004 <PPSDO_CONFIG_ONE_S_TARGET>`     |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_CONFIG_ONE_S_TOL <PPSDO_CONFIG_ONE_S_TOL>`               | :ref:`0xf000f008 <PPSDO_CONFIG_ONE_S_TOL>`        |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_CONFIG_TEN_S_TARGET <PPSDO_CONFIG_TEN_S_TARGET>`         | :ref:`0xf000f00c <PPSDO_CONFIG_TEN_S_TARGET>`     |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_CONFIG_TEN_S_TOL <PPSDO_CONFIG_TEN_S_TOL>`               | :ref:`0xf000f010 <PPSDO_CONFIG_TEN_S_TOL>`        |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_CONFIG_HUNDRED_S_TARGET <PPSDO_CONFIG_HUNDRED_S_TARGET>` | :ref:`0xf000f014 <PPSDO_CONFIG_HUNDRED_S_TARGET>` |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_CONFIG_HUNDRED_S_TOL <PPSDO_CONFIG_HUNDRED_S_TOL>`       | :ref:`0xf000f018 <PPSDO_CONFIG_HUNDRED_S_TOL>`    |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_STATUS_ONE_S_ERROR <PPSDO_STATUS_ONE_S_ERROR>`           | :ref:`0xf000f01c <PPSDO_STATUS_ONE_S_ERROR>`      |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_STATUS_TEN_S_ERROR <PPSDO_STATUS_TEN_S_ERROR>`           | :ref:`0xf000f020 <PPSDO_STATUS_TEN_S_ERROR>`      |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_STATUS_HUNDRED_S_ERROR <PPSDO_STATUS_HUNDRED_S_ERROR>`   | :ref:`0xf000f024 <PPSDO_STATUS_HUNDRED_S_ERROR>`  |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_STATUS_DAC_TUNED_VAL <PPSDO_STATUS_DAC_TUNED_VAL>`       | :ref:`0xf000f028 <PPSDO_STATUS_DAC_TUNED_VAL>`    |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_STATUS_ACCURACY <PPSDO_STATUS_ACCURACY>`                 | :ref:`0xf000f02c <PPSDO_STATUS_ACCURACY>`         |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_STATUS_PPS_ACTIVE <PPSDO_STATUS_PPS_ACTIVE>`             | :ref:`0xf000f030 <PPSDO_STATUS_PPS_ACTIVE>`       |
+----------------------------------------------------------------------+---------------------------------------------------+
| :ref:`PPSDO_STATUS_STATE <PPSDO_STATUS_STATE>`                       | :ref:`0xf000f034 <PPSDO_STATUS_STATE>`            |
+----------------------------------------------------------------------+---------------------------------------------------+
...
`Address: 0xf000f000 + 0x1c = 0xf000f01c`
...
`Address: 0xf000f000 + 0x20 = 0xf000f020`
...
`Address: 0xf000f000 + 0x24 = 0xf000f024`
...
`Address: 0xf000f000 + 0x28 = 0xf000f028`
...
`Address: 0xf000f000 + 0x2c = 0xf000f02c`
...
`Address: 0xf000f000 + 0x30 = 0xf000f030`
...
`Address: 0xf000f000 + 0x34 = 0xf000f034`
