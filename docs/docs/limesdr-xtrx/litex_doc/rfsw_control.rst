...
| Register                                                         | Address                                         |
+==================================================================+=================================================+
| :ref:`RFSW_CONTROL_TDD_MANUAL_VAL <RFSW_CONTROL_TDD_MANUAL_VAL>` | :ref:`0xf000b800 <RFSW_CONTROL_TDD_MANUAL_VAL>` |
+------------------------------------------------------------------+-------------------------------------------------+
| :ref:`RFSW_CONTROL_TDD_AUTO_EN <RFSW_CONTROL_TDD_AUTO_EN>`       | :ref:`0xf000b804 <RFSW_CONTROL_TDD_AUTO_EN>`    |
+------------------------------------------------------------------+-------------------------------------------------+
| :ref:`RFSW_CONTROL_TDD_INVERT <RFSW_CONTROL_TDD_INVERT>`         | :ref:`0xf000b808 <RFSW_CONTROL_TDD_INVERT>`     |
+------------------------------------------------------------------+-------------------------------------------------+
| :ref:`RFSW_CONTROL_RFSW_RX <RFSW_CONTROL_RFSW_RX>`               | :ref:`0xf000b80c <RFSW_CONTROL_RFSW_RX>`        |
+------------------------------------------------------------------+-------------------------------------------------+
| :ref:`RFSW_CONTROL_RFSW_TX <RFSW_CONTROL_RFSW_TX>`               | :ref:`0xf000b810 <RFSW_CONTROL_RFSW_TX>`        |
+------------------------------------------------------------------+-------------------------------------------------+
| :ref:`RFSW_CONTROL_RFSW_AUTO_EN <RFSW_CONTROL_RFSW_AUTO_EN>`     | :ref:`0xf000b814 <RFSW_CONTROL_RFSW_AUTO_EN>`   |
+------------------------------------------------------------------+-------------------------------------------------+
