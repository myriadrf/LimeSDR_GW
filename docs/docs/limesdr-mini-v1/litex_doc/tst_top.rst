...
| Register                                           | Address                                  |
+====================================================+==========================================+
| :ref:`TST_TOP_TEST_EN <TST_TOP_TEST_EN>`           | :ref:`0xf0005000 <TST_TOP_TEST_EN>`      |
+----------------------------------------------------+------------------------------------------+
| :ref:`TST_TOP_TEST_FRC_ERR <TST_TOP_TEST_FRC_ERR>` | :ref:`0xf0005004 <TST_TOP_TEST_FRC_ERR>` |
+----------------------------------------------------+------------------------------------------+
| :ref:`TST_TOP_TEST_CMPLT <TST_TOP_TEST_CMPLT>`     | :ref:`0xf0005008 <TST_TOP_TEST_CMPLT>`   |
+----------------------------------------------------+------------------------------------------+
| :ref:`TST_TOP_TEST_REZ <TST_TOP_TEST_REZ>`         | :ref:`0xf000500c <TST_TOP_TEST_REZ>`     |
+----------------------------------------------------+------------------------------------------+
| :ref:`TST_TOP_FX3_CLK_CNT <TST_TOP_FX3_CLK_CNT>`   | :ref:`0xf0005010 <TST_TOP_FX3_CLK_CNT>`  |
+----------------------------------------------------+------------------------------------------+
| :ref:`TST_TOP_LMK_CLK_CNT0 <TST_TOP_LMK_CLK_CNT0>` | :ref:`0xf0005014 <TST_TOP_LMK_CLK_CNT0>` |
+----------------------------------------------------+------------------------------------------+
| :ref:`TST_TOP_LMK_CLK_CNT1 <TST_TOP_LMK_CLK_CNT1>` | :ref:`0xf0005018 <TST_TOP_LMK_CLK_CNT1>` |
+----------------------------------------------------+------------------------------------------+
| :ref:`TST_TOP_ADF_CNT <TST_TOP_ADF_CNT>`           | :ref:`0xf000501c <TST_TOP_ADF_CNT>`      |
+----------------------------------------------------+------------------------------------------+
| :ref:`TST_TOP_TX_TST_I <TST_TOP_TX_TST_I>`         | :ref:`0xf0005020 <TST_TOP_TX_TST_I>`     |
+----------------------------------------------------+------------------------------------------+
| :ref:`TST_TOP_TX_TST_Q <TST_TOP_TX_TST_Q>`         | :ref:`0xf0005024 <TST_TOP_TX_TST_Q>`     |
+----------------------------------------------------+------------------------------------------+
