...
| Register                                                                 | Address                                             |
+==========================================================================+=====================================================+
| :ref:`INTERNAL_FLASH_STATUS_REGISTER <INTERNAL_FLASH_STATUS_REGISTER>`   | :ref:`0xf0002800 <INTERNAL_FLASH_STATUS_REGISTER>`  |
+--------------------------------------------------------------------------+-----------------------------------------------------+
| :ref:`INTERNAL_FLASH_CONTROL_REGISTER <INTERNAL_FLASH_CONTROL_REGISTER>` | :ref:`0xf0002804 <INTERNAL_FLASH_CONTROL_REGISTER>` |
+--------------------------------------------------------------------------+-----------------------------------------------------+
