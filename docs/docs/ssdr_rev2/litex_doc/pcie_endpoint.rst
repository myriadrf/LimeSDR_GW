...
| Register                                                                         | Address                                                 |
+==================================================================================+=========================================================+
| :ref:`PCIE_ENDPOINT_PHY_LINK_STATUS <PCIE_ENDPOINT_PHY_LINK_STATUS>`             | :ref:`0xf0005800 <PCIE_ENDPOINT_PHY_LINK_STATUS>`       |
+----------------------------------------------------------------------------------+---------------------------------------------------------+
| :ref:`PCIE_ENDPOINT_PHY_MSI_ENABLE <PCIE_ENDPOINT_PHY_MSI_ENABLE>`               | :ref:`0xf0005804 <PCIE_ENDPOINT_PHY_MSI_ENABLE>`        |
+----------------------------------------------------------------------------------+---------------------------------------------------------+
| :ref:`PCIE_ENDPOINT_PHY_MSIX_ENABLE <PCIE_ENDPOINT_PHY_MSIX_ENABLE>`             | :ref:`0xf0005808 <PCIE_ENDPOINT_PHY_MSIX_ENABLE>`       |
+----------------------------------------------------------------------------------+---------------------------------------------------------+
| :ref:`PCIE_ENDPOINT_PHY_BUS_MASTER_ENABLE <PCIE_ENDPOINT_PHY_BUS_MASTER_ENABLE>` | :ref:`0xf000580c <PCIE_ENDPOINT_PHY_BUS_MASTER_ENABLE>` |
+----------------------------------------------------------------------------------+---------------------------------------------------------+
| :ref:`PCIE_ENDPOINT_PHY_MAX_REQUEST_SIZE <PCIE_ENDPOINT_PHY_MAX_REQUEST_SIZE>`   | :ref:`0xf0005810 <PCIE_ENDPOINT_PHY_MAX_REQUEST_SIZE>`  |
+----------------------------------------------------------------------------------+---------------------------------------------------------+
| :ref:`PCIE_ENDPOINT_PHY_MAX_PAYLOAD_SIZE <PCIE_ENDPOINT_PHY_MAX_PAYLOAD_SIZE>`   | :ref:`0xf0005814 <PCIE_ENDPOINT_PHY_MAX_PAYLOAD_SIZE>`  |
+----------------------------------------------------------------------------------+---------------------------------------------------------+
